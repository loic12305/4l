...
<LI><a>Frais d’inscription : 3225€ (-150€)</a></LI>
<OL>
...
<li><a>Divers et imprévus : 500€</a></li>
...
<p>Chez Clémence Delille<br/>21 rue des chanoines - 72000 Le Mans, France</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer">
                    <p class="footer-text">v1.1.2<!-- <marquee scrollamount="5"  DIRECTION="up"> --><!-- </marquee> --></p>
                </div><!-- /.footer --> 
            </div>
